...
float  PerlinNoise1234::grad( int hash, float x ) {
    int h = hash & 15;
...
float  PerlinNoise1234::grad( int hash, float x, float y ) {
...
float  PerlinNoise1234::grad( int hash, float x, float y , float z ) {
...
float  PerlinNoise1234::grad( int hash, float x, float y, float z, float t ) {
 ...
 */
float PerlinNoise1234::noise( float x )
{
    int ix0, ix1;
    float fx0, fx1;
    float s, n0, n1;
 ...
 */
float PerlinNoise1234::pnoise( float x, int px )
{
    int ix0, ix1;
    float fx0, fx1;
    float s, n0, n1;
 ...
 */
float PerlinNoise1234::noise( float x, float y )
{
    int ix0, iy0, ix1, iy1;
 ...
 */
float PerlinNoise1234::pnoise( float x, float y, int px, int py )
{
    int ix0, iy0, ix1, iy1;
    float fx0, fy0, fx1, fy1;
    float s, t, nx0, nx1, n0, n1;
 ...
 */
float PerlinNoise1234::noise( float x, float y, float z )
{
 ...
 */
float PerlinNoise1234::pnoise( float x, float y, float z, int px, int py, int pz )
{
    int ix0, iy0, ix1, iy1, iz0, iz1;
    float fx0, fy0, fz0, fx1, fy1, fz1;
    float s, t, r;
...
float PerlinNoise1234::noise( float x, float y, float z, float w )
{
...
float PerlinNoise1234::pnoise( float x, float y, float z, float w,
